...
import { e as createComponent, f as createAstro, r as renderTemplate, h as addAttribute, k as renderHead } from '../chunks/astro/server_OX3wzgTe.mjs';
import { a as fetchProfile, t as toAbsoluteUrl } from '../chunks/bluesky-api_NmgXzFK9.mjs';
/* empty css                                     */
...
const $$handle = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ogTitle = `${displayName} on orbyt`;
  const ogDescription = description.length > 200 ? description.substring(0, 200) + "..." : description;
  return renderTemplate(_a || (_a = __template(['<html lang="en" data-astro-cid-n44cr2l3> <head><meta charset="utf-8"><link rel="stylesheet" href="/css/normalize.css"><link rel="stylesheet" href="/css/skeleton.css"><link rel="stylesheet" href="/css/shared.css"><link rel="stylesheet" href="/css/profile.css"><title>', '</title><meta name="description"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><meta property="og:url"', '><meta property="og:type" content="profile"><meta property="og:site_name" content="orbyt"><meta property="og:locale" content="en_US"><meta property="twitter:card" content="summary"><meta property="twitter:site" content="orbyt_video"><meta property="twitter:title"', '><meta property="twitter:description"', '><meta property="twitter:image"', `><meta name="viewport" content="width=device-width, initial-scale=1"><!-- Favicon setup --><!-- iOS apple-touch-icon (iOS doesn't support media queries, use dark icon) --><link rel="apple-touch-icon" sizes="180x180" href="/favicon_dark/apple-touch-icon.png"><!-- Default/fallback favicons (for unsupported browsers - use favicon_io) --><link rel="icon" type="image/x-icon" href="/favicon_io/favicon.ico"><link rel="icon" type="image/png" sizes="32x32" href="/favicon_io/favicon-32x32.png"><link rel="icon" type="image/png" sizes="16x16" href="/favicon_io/favicon-16x16.png"><!-- Light mode favicons --><link rel="icon" type="image/x-icon" href="/favicon_light/favicon.ico" media="(prefers-color-scheme: light)"><link rel="icon" type="image/png" sizes="16x16" href="/favicon_light/favicon-16x16.png" media="(prefers-color-scheme: light)"><link rel="icon" type="image/png" sizes="32x32" href="/favicon_light/favicon-32x32.png" media="(prefers-color-scheme: light)"><!-- Dark mode favicons --><link rel="icon" type="image/x-icon" href="/favicon_dark/favicon.ico" media="(prefers-color-scheme: dark)"><link rel="icon" type="image/png" sizes="16x16" href="/favicon_dark/favicon-16x16.png" media="(prefers-color-scheme: dark)"><link rel="icon" type="image/png" sizes="32x32" href="/favicon_dark/favicon-32x32.png" media="(prefers-color-scheme: dark)"><link rel="manifest" href="/favicon_io/site.webmanifest">`, '</head> <body data-astro-cid-n44cr2l3> <div id="profile"', ` data-astro-cid-n44cr2l3> <header class="hidden" data-astro-cid-n44cr2l3> <div class="links" data-astro-cid-n44cr2l3> <a href="/" class="logo-wordmark" data-astro-cid-n44cr2l3> <span class="logo-text" data-astro-cid-n44cr2l3>orbyt</span> </a> <a class="install-button mobile" href="/beta" data-astro-cid-n44cr2l3>
Waitlist
...
Waitlist
<svg class="svg-button" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg" data-astro-cid-n44cr2l3> <path d="M1.93892 19.9988L18.9736 2.96362" stroke="black" stroke-width="3.993" data-astro-cid-n44cr2l3></path> <path d="M19 16.7368L19 2.93875L5.20193 2.93875" stroke="black" stroke-width="3.993" data-astro-cid-n44cr2l3></path> </svg> </a> </div> </header> <div class="posts" data-astro-cid-n44cr2l3> <div id="profile-error" style="display: none;" class="profile-error-container" data-astro-cid-n44cr2l3> <p id="profile-error-message" class="profile-error-message" data-astro-cid-n44cr2l3>We couldn't find that account</p> <div class="profile-error-hints" data-astro-cid-n44cr2l3> <div class="hint" data-astro-cid-n44cr2l3> <span class="hint-text" data-astro-cid-n44cr2l3>Make sure to include the @ symbol before the handle</span> <span class="hint-example" data-astro-cid-n44cr2l3> (e.g., getorbyt.com/@example.com)</span> </div> <div class="hint" data-astro-cid-n44cr2l3> <span class="hint-text" data-astro-cid-n44cr2l3>Use the complete handle including all parts</span> <span class="hint-example" data-astro-cid-n44cr2l3> (e.g., @example.orbyt.video)</span> </div> </div> </div> <footer style="display: none;" data-astro-cid-n44cr2l3> <a id="load-more" data-astro-cid-n44cr2l3>Load more</a> </footer> </div> </div> <script type="module">
...
<\/script> </body> </html>`])), ogTitle, addAttribute(ogDescription, "content"), addAttribute(ogTitle, "content"), addAttribute(ogDescription, "content"), addAttribute(ogImage, "content"), addAttribute(ogUrl, "content"), addAttribute(ogTitle, "content"), addAttribute(ogDescription, "content"), addAttribute(ogImage, "content"), renderHead(), addAttribute(handle, "data-handle"));
